...
//	alert($(document).width()/$(document).height())
	if($(document).width()/$(document).height() > 0.72){
		$(".mf-list li.list2").css("height","20.6%");
		$(".mf-list li.list3").css("height","26.1%");
	...
	else if($(document).width()/$(document).height() >= 0.70)
	{
		...
		$(".animateTree").css("bottom", "-22%");
		$(".achieve-common").css("top","50%");
	}
	else if($(document).width()/$(document).height() >= 0.62){
		$(".animateTree").css("bottom", "-18%");
		$(".achieve-common").css("top","50%");
...
//	});
	...
	width_height(".ball4");
		...
		$(".all > div").on("tap",function(){
			var i = $(this).index() + 1;
			$(".achieve > div").find(".achieve-title").animate({left:"-100%",opacity:"0"},1000);
			$(".achieve > div").find(".achieve-detail").animate({right:"-100%",opacity:"0"},1000);
			$(".achieve"+i).find(".achieve-title").animate({left:"0",opacity:"1"},1000);
			$(".achieve"+i).find(".achieve-detail").animate({right:"0",opacity:"1",top:"30px"},1000);
		})
...
//								break;
//								case -1:
//								$(".animateTree").stop().find(".list1").animate({left:"4.5%",opacity:"1"},1200,function(){
//									$(".list2").animate({top:"32.2%",opacity:"1"},1200,function(){
//										$(".list3").delay(300).animate({top:"56.3%",opacity:"1"},1200,function(){
//											$(".list4").delay(300).animate({right:"4.5%",opacity:"1"},1200,function(){
//												$(".next-button").show(1000);
//											})
//										})
//									})
					...
					if(num > 0)
					{
						...
						switch(num)
						{
							...
							$(".tree-first.bg-green").find(".list1").animate({left:"4.5%",opacity:"1"},1200,function(){
								$(".list2").animate({top:"35.2%",opacity:"1"},1200,function(){
									$(".list3").animate({top:"55.3%",opacity:"1"},1200,function(){
...
//								break;
//								case -2:
//								$(".list1").animate({left:"100%"},1000);
//								$(".list2").animate({top:"-29%"},1000);
//								$(".list3").animate({top:"100%"},1000);
//								$(".list4").animate({right:"100%"},1000);
//								$(".ceo-list").find("li").eq(0).animate({opacity:"1"},1000);
//								setTimeout(function(){
//									$(".ceo-list").find("li").eq(1).animate({opacity:"1"},1000);
//								},700)
